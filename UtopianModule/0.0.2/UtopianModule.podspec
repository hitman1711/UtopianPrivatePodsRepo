...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://bitbucket.org/tumarsal3/utopiamodule'
  s.authors = { 'Arthur' => 'coding4life@icloud.com' }
  s.source = { :git => 'https://bitbucket.org/tumarsal3/utopiamodule.git', :tag => s.version }
  s.ios.deployment_target = '9.0'
  s.source_files = 'Source/*.swift'
  s.resource_bundles = {
    'UtopianModule' => ['Resources/**/*.{png}']
  }
# s.module_name = 'UtopianModule'
